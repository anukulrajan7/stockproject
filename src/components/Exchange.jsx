...
function index() {
  return (
    <div className='flex w-ful px-5 lg:w-[80%] flex-col mx-auto shadow-md rounded-sm py-3 gap-4 my-2'>
        ...
        <div className='flex flex-col lg:flex-row justify-between  px-3 w-full gap-9'>
              <h2 className='flex  lg:flex-col bg-gray-200 px-2 py-2 text-indigo-700'> <span>Market cap (lakh)</span> {data.exchange_snapshot.market_cap_in_lakhs.equity}</h2>
